#import "VolumeBrightnessPlugin.h"
#import <MediaPlayer/MediaPlayer.h>
#import <AVKit/AVKit.h>
#include <sys/param.h>
#include <sys/mount.h>

@interface VolumeBrightnessPlugin()

@property (strong, nonatomic) MPMusicPlayerController* musicController;

@end

@implementation VolumeBrightnessPlugin

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"brightness_volume"
                                     binaryMessenger:[registrar messenger]];
    VolumeBrightnessPlugin* instance = [[VolumeBrightnessPlugin alloc] init];
